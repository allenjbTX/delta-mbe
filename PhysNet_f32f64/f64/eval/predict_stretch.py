...
#setup calculator
calc = NNCalculator(
    checkpoint="models_f64/ch2o_mp2_avtz_3601_f64_b", #load the model you want to used
    atoms=atoms,
    charge=args.charge,
    F=128,
    K=64,
...
traj = Trajectory('dissociating_h_f64_h2co_mp2.traj', 'w', atoms)
...
np.savetxt('dissociating_h_f64_h2co_mp2.dat', np.c_[r, np.array(epot)*23.0605])
